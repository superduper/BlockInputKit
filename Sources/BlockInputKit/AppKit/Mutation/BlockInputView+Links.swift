...
extension BlockInputView {
    ...
    func showLinkModal(context: BlockInputLinkContext, text prefilledText: String? = nil, urlString prefilledURLString: String? = nil) {
        ...
        case .edit(let linkRange):
            mode = .edit
            // Wiki links are ordinary `[Title](wiki://slug)` links now, so the standard two-field label/destination modal
            // already shows the Title and the `wiki://` destination with no special-casing.
